...
public class JDBC_Query_3 {
    public static void main(String[] args) throws SQLException {
        /*
        User tablosundaki hastalardan user_id'si 10 dan buyuk ve 15 den kucuk olanlarin username ve
        password bilgilerini yazdirin.
         */
      ...
      Statement st= ResuableMethods.createStatement(ResuableMethods.getConnection());
        ...
        System.out.println("-------------------------------");
        /*
        Transactions tablosundan Blood Bank tan işlem yapan hastalarin patiend_id ve amount bilgilerini kucukten buuge gore
